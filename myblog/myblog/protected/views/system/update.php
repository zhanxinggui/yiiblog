...
<dl id="mobilePwdDl" class="regForm-item">
	...
	<span class="txt-impt">*</span><?php echo $form->labelEx($model,'site_name');?> 
	</dt>
	<dd class="regForm-item-ct">
	<?php echo $form->textField($model,'site_name',array('class'=>'ipt norWidthIpt','id'=>'mobilePwdIpt'));?>
	<div id="mobilePwdTips" class="tips" style="position: relative;">
	<?php echo $form->error($model,'site_name',array('class'=>'txt-tips'));?>
	</div>
	</dd>
</dl>
...
<dl id="mobilePwdDl" class="regForm-item">
	<dt class="regForm-item-tit">
	<span class="txt-impt">*</span><?php echo $form->labelEx($model,'keywords');?> 
	</dt>
	<dd class="regForm-item-ct">
	<?php echo $form->textArea($model,'keywords',array('class'=>'ipt norWidthIpt','id'=>'mobilePwdIpt','rows'=>6,'cols'=>50));?>
	<div id="mobilePwdTips" class="tips" style="position: relative;">
	<?php echo $form->error($model,'keywords',array('class'=>'txt-tips'));?>
	</div>
	</dd>
</dl>
<dl id="mobilePwdDl" class="regForm-item">
	<dt class="regForm-item-tit">
	<span class="txt-impt">*</span><?php echo $form->labelEx($model,'copyright');?> 
	</dt>
	<dd class="regForm-item-ct">
	<?php echo $form->textField($model,'copyright',array('class'=>'ipt norWidthIpt','id'=>'mobilePwdIpt'));?>
	<div id="mobilePwdTips" class="tips" style="position: relative;">
	<?php echo $form->error($model,'copyright',array('class'=>'txt-tips'));?>
	</div>
	</dd>
</dl>
<dl id="mobilePwdDl" class="regForm-item">
	<dt class="regForm-item-tit">
	<span class="txt-impt">*</span><?php echo $form->labelEx($model,'site_url');?> 
	</dt>
	<dd class="regForm-item-ct">
	<?php echo $form->urlField($model,'site_url',array('class'=>'ipt norWidthIpt','id'=>'mobilePwdIpt'));?>
	<div id="mobilePwdTips" class="tips" style="position: relative;">
	<?php echo $form->error($model,'site_url',array('class'=>'txt-tips'));?>
	</div>
	</dd>
</dl>

<dl id="acodeDl" class="regForm-item">
	<dt class="regForm-item-tit"><span class="txt-impt">*</span><?php echo $form->labelEx($model,'copyright');?> </dt>
	<dd class="regForm-item-ct">
	<?php echo $form->textField($model,'copyright',array('class'=>'ipt norWidthIpt','id'=>'mobilePwdIpt'));?>
