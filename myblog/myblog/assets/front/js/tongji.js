...
{
	var unit_id     = "2975299";
	var client_ip   = "183.61.187.169";
	var server_time = "1376557998";
	var verify_code = "615636f1";
	var type        = "2";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.alimama.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/2975299/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
